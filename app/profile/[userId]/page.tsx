...
export default function ProfilePage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      let existingProfile = await getProfileByUserIdClient(userId);

      // If no profile and it's the current user, create one
      if (!existingProfile && user && user.$id === userId) {
      ...
      setStats(userStats);
      setRecentPosts(
        userPosts as { $id: string; $createdAt: string; title?: string }[]
      );
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="font-mono text-foreground/60">Đang tải profile...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background py-8 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="relative">
          {/* Background Banner */}
          <div className="h-48 bg-gradient-to-r from-primary/20 via-secondary/20 to-accent/20 rounded-2xl border border-border overflow-hidden">
          ...
          <div className="relative -mt-20 mx-4 sm:mx-8">
            <div className="bg-surface/80 backdrop-blur-xl border border-border rounded-2xl p-6 sm:p-8">
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                {/* Avatar */}
                <div className="relative">
                  <div className="w-32 h-32 rounded-full border-4 border-primary/50 overflow-hidden bg-surface shadow-[0_0_30px_rgba(0,255,159,0.3)]">
                    <Image
                  ...
                  {/* Online indicator */}
                  <div className="absolute bottom-2 right-2 w-5 h-5 bg-primary rounded-full border-2 border-surface animate-pulse"></div>
                </div>
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  {profile?.location && (
                    <p className="flex items-center justify-center sm:justify-start gap-2 text-foreground/60 font-mono text-sm mb-4">
                      <svg
                        className="w-4 h-4"
                        fill="none"
                        stroke="currentColor"
                  ...
                  <div className="flex flex-wrap justify-center sm:justify-start gap-4 mb-4">
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 bg-secondary/10 border border-secondary/30 rounded-lg">
                      <svg
